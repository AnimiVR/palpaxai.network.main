...
```html
<div class="container-PalPaxAI">Max-width container</div>
...
```html
<div class="gradient-PalPaxAI">PalPaxAI Brand Gradient</div>
...
```html
<h1 class="text-gradient-PalPaxAI">Gradient Text</h1>
